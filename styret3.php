...
<?php $post_id = $post->ID; ?>
	    ...
	    <div id="main">
			...
			<div class="box-main curved light">
				<h1>Sosialansvarlig</h1>
				<img src="<?=get_post_meta($post_id, 'Sosial-bildeurl', true); ?>" alt="Communica" class="styret-profilbilde" />
				<p>
				<h3><?=get_post_meta($post_id, 'Sosial-navn', true); ?></h3>
				<div class="styret-tabell">
					<div class="styret-tabell-v"><strong>Klasse</strong></div>
					<div class="styret-tabell-m"><strong>Telefon</strong></div>
					<div class="styret-tabell-h"><strong>E-post</strong></div>
				...
				<br />
				<div class="styret-tabell">
					<div class="styret-tabell-v"><?=get_post_meta($post_id, 'Sosial-klasse', true); ?></div>
					<div class="styret-tabell-m"><?=get_post_meta($post_id, 'Sosial-tlf', true); ?></div>
					<div class="styret-tabell-h"><?=get_post_meta($post_id, 'Sosial-epost', true); ?></div>
				</div>
				</p>
			</div>
